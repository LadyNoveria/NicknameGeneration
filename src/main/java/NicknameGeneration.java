...
public class NicknameGeneration {
    ...
    public void findBeautifulWords() throws InterruptedException {
    ...
    private boolean doesItConsistOfOneLetter(String text) {
    ...
    private boolean areLettersArrangedInAscOrder(String text) {
